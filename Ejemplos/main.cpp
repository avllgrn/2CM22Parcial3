...
int main(void){
    ...
    //Pruebas de dameTuAtributoNumeroGrupos(),dameTuAtributoCarga(),dameTuAtributoAcademia()
    //modificaTuAtributoNumeroGrupos(),modificaTuAtributoCarga() y modificaTuAtributAcademia()
    cout<<"E1"<<endl;E1.muestraTuEstado();cout<<endl<<endl;
    cout<<"E2"<<endl;E2.muestraTuEstado();cout<<endl<<endl;
